...
export class ShareInformationPage {
    ...
    constructor(public helper: Helper, public sanitizationService: DomSanitizer, public view: ViewController, 
        public globalVars: GlobalVars, public performanceService: PerformanceService, public renderer: Renderer) {
    ...
    loadPhrases() {
        ...
        this.shareinfoListText = {
            shareinfoNote: this.sanitizationService.bypassSecurityTrustHtml(shareDataNote.replace("<a>", "<a class='link-to-settings' id='shareinfo_linktosettings'>")),
        ...
        setTimeout(()=>{
            this.renderer.listen(document.getElementById("shareinfo_linktosettings"), 'click', (event) => {
