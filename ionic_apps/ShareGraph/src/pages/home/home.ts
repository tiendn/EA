...
import { SocialSharing, Globalization, Deeplinks } from 'ionic-native';
...
@Component({
    ...
    providers: [TickerService, ChartService]
})
export class HomePage {
    ...
    constructor(platform: Platform, public navCtrl: NavController, public domSanitizer: DomSanitizer,
        ...
        public helper: Helper, public tickerService: TickerService, public chartService: ChartService, public authService: AuthService, public profileService: ProfileService) {
