...
export declare class Calendar {
     ...
     */
    static hasReadWritePermissions(): Promise<boolean>;
    /**
     ...
     * @return Returns a Promise
     */
    static modifyEventWithOptions(title?: string, location?: string, notes?: string, startDate?: Date, endDate?: Date, newTitle?: string, newLocation?: string, newNotes?: string, newStartDate?: Date, newEndDate?: Date, options?: CalendarOptions): void;
    /**
     * Delete an event.
     *
     * @param {string} [title]  The event title
